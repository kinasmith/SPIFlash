...
# SPIFlash_Marzogh [![Build Status](https://travis-ci.org/Marzogh/SPIFlash_Marzogh.svg?branch=master)](https://travis-ci.org/Marzogh/SPIFlash_Marzogh) [![DOI](https://zenodo.org/badge/18908/Marzogh/SPIFlash_Marzogh.svg)](https://zenodo.org/badge/latestdoi/18908/Marzogh/SPIFlash_Marzogh)
### Arduino library for Winbond Flash Memory Chips
<sup> Download the latest stable release (v2.5.0) from <a href = "https://github.com/Marzogh/SPIFlash_Marzogh/releases/latest">here</a>. Please report any bugs in issues.</sup>
...
- Unzip the archive and rename resulting folder to 'SPIFlash_Marzogh'
- Move the folder to your libraries folder (~/sketches/libraries)

#####Option 2
- Open the Arduino IDE.
- Go to Sketch > Include Library > Manage libraries.
- Search for SPIFlash_Marzogh.
...
Make sure to include ```#include<SPI.H>``` when you include ```#include<SPIFlash_Marzogh.h>```.
...
###### error()
Returns the (8-bit) error code generated by the function called immediately before this is called. Refer to the [Error codes & Error reporting] (https://github.com/Marzogh/SPIFlash_Marzogh/wiki/Error-codes-&-Error-reporting) section the Wiki for further reference.
###### getMANID()
...
They can be used by uncommenting them in the SPIFlash_Marzogh.cpp file. However, be warned, this particular block of code has only been tested with the Arduino	IDE (1.6.5) and only with 8-bit ATMega based Arduino boards and will not be supported any further.
